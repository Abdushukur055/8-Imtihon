...
const menuItems: MenuItem[] = [
  { title: "Guides", path: "/components/guides" },
  { title: "Users", path: "/components/users" },
  {title:"Profile",path:"/components/user_admin"}
];
    ...
    <div className="w-[350px] h-[100vh] bg-[#182237] py-[35px] px-[20px] flex flex-col gap-[20px] fixed">
      <div className="flex items-center gap-[15px]">
        ...
        <div className="flex flex-col">
          <h3 className="text-white text-[18px]">Arslonbek Ro'ziboyev</h3>
          <h3 className="text-[#b7bac1] text-[12px]">Admin</h3>
        </div>
      </div>
